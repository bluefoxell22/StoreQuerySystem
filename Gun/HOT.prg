...
DEFINE PAD angpad   OF _MSYSMENU PROMPT '\<Suplier   '  COLOR SCHEME 3 ;
	...
	skip for upper(left(ASMO,5))='KASIR'
DEFINE PAD aggpad   OF _MSYSMENU PROMPT '\<Anggota   '  COLOR SCHEME 3 ;
	KEY ALT+A, '' mess'Menu kontrol Anggota';
	skip for upper(left(ASMO,5))='KASIR'
...
DEFINE PAD simpad OF _MSYSMENU PROMPT 'Sim\<panan   ' COLOR SCHEME 3 ;
	KEY ALT+G, '' mess'Menu Kontrol Simpanan';
	skip for upper(left(ASMO,5))='KASIR'
DEFINE PAD akupad OF _MSYSMENU PROMPT 'A\<kuntansi   ' COLOR SCHEME 3 ;
	KEY ALT+G, '' mess'Menu Kontrol Akuntansi';
	skip for upper(left(ASMO,5))='KASIR'
...
on pad simpad of _MSYSMENU activate popup simpop
on pad akupad of _MSYSMENU activate popup akupop
...
DEFINE BAR 1 OF aggpop PROMPT '\<Entry Instansi' mess 'Memasukkan data-data instansi'
DEFINE BAR 2 OF aggpop PROMPT '\<Daftar' mess 'Melihat data-data instansi'
DEFINE BAR 3 OF aggpop PROMPT '\-'
DEFINE BAR 4 OF aggpop PROMPT 'Entry \<Anggota'mess'Memasukkan data-data anggota'
DEFINE BAR 5 OF aggpop PROMPT 'Da\<ftar'mess'Melihat data-data anggota'
DEFINE BAR 6 OF aggpop PROMPT '\-'
DEFINE BAR 7 OF aggpop PROMPT 'Entry An\<gsuran' mess 'angsuran piutang anggota'
DEFINE BAR 8 OF aggpop PROMPT 'Edit An\<gsuran' mess 'merubah angsuran piutang anggota'
DEFINE BAR 9 OF aggpop PROMPT '\-'
DEFINE BAR 10 OF aggpop PROMPT 'Entry Angsuran \<Sekunder' mess 'angsuran piutang sekunder anggota'
DEFINE BAR 11 OF aggpop PROMPT 'Edit Angsuran Se\<kunder' mess 'merubah angsuran piutang sekunder anggota'
on bar 2 of aggpop activate popup aggpop1
on bar 5 of aggpop activate popup aggpop2
on bar 7 of aggpop activate popup kpApop2
on bar 8 of aggpop activate popup kpApop3
on bar 10 of aggpop activate popup kpApop4
on bar 11 of aggpop activate popup kpApop5
*
...
DEFINE BAR  2 OF kpbpop PROMPT 'E\<dit' mess 'Merubah/menghapus data-data pembelian';
	skip for left(ASMO,10)#'SUPERVISOR'
...
DEFINE BAR  4 OF kpApop PROMPT 'Entry \<Sekunder' mess 'Memasukkan data-data per nota penjualan sekunder'
DEFINE BAR  5 OF kpApop PROMPT 'Edit Se\<kunder' mess 'Merubah/menghapus data-data penjualan sekunder';
	skip for left(ASMO,10)#'SUPERVISOR'
DEFINE BAR  6 OF kpApop PROMPT '\-'
DEFINE BAR  7 OF kpApop PROMPT 'Da\<ftar Penjualan' mess'Melihat data penjualan secara global'
DEFINE BAR  8 OF kpApop PROMPT 'Daftar Penjualan \<Tunai / Kredit' mess'Melihat data penjualan tunai'
DEFINE BAR  9 OF kpApop PROMPT 'Daftar Penjualan / An\<ggota' mess'Melihat data penjualan per Anggota'
DEFINE BAR 10 OF kpApop PROMPT 'Daftar Penjualan / \<Item' mess'Melihat data penjualan per item'
DEFINE BAR 11 OF kpApop PROMPT 'Daftar \<% Selling' mess 'Melihat data-data prosentase penjualan'
DEFINE BAR 12 OF kpApop PROMPT '\-'
DEFINE BAR 13 OF kpApop PROMPT '\<Tagihan' mess 'penagihan piutang anggota'
on selection bar 1 of kpApop do ejual in menu
on selection bar 2 of kpApop do edjual in menu
on selection bar 4 of kpApop do eseku in menu
on selection bar 5 of kpApop do edseku in menu
on bar 7 of kpApop activate popup kpApop11
on bar 8 of kpApop activate popup kpApop12
on selection bar 9 of kpApop do ljual13 in menu
on selection bar 10 of kpApop do ljual12 in menu
on selection bar 11 of kpApop do persel in menu
on bar 13 of kpApop activate popup kpApop1
*
...
clos data
*
DEFINE POPUP akupop MARGIN RELATIVE SHADOW COLOR SCHEME 4
DEFINE BAR  1 OF akupop PROMPT '\<Entry Rekening' mess'Memasukkan rekening'
DEFINE BAR  2 OF akupop PROMPT '\<Daftar' mess'melihat sekelompok rekening'
DEFINE BAR  3 OF akupop PROMPT '\-' 
DEFINE BAR  4 OF akupop PROMPT 'K\<M' mess'memasukkan kas masuk'
DEFINE BAR  5 OF akupop PROMPT 'K\<K' mess'memasukkan kas Keluar'
DEFINE BAR  6 OF akupop PROMPT 'Mu\<tasi Adjustment, BU' mess'memasukkan Adjustment, BU'
DEFINE BAR  7 OF akupop PROMPT '\-' 
DEFINE BAR  8 OF akupop PROMPT 'Buku \<Besar' mess'Melihat buku besar'
DEFINE BAR  9 OF akupop PROMPT '\<Neraca' mess'Melihat Neraca'
on selection bar 1 of akupop do erek in menu
on selection bar 2 of akupop do lrek in menu
on selection bar 4 of akupop do ekm in menu
on selection bar 5 of akupop do ekk in menu
on selection bar 6 of akupop do mutas in menu
on selection bar 8 of akupop do laperk in menu
on selection bar 9 of akupop do nerac in menu
*
...
DEFINE BAR 7 OF indpop PROMPT 'Editing Rep\<ort Penjualan' mess'Melihat perubahan data Penjualan yang dilakukan SUPERVISOR'
DEFINE BAR 8 OF indpop PROMPT 'Edit\<ing Report Pembelian' mess'Melihat perubahan data Pembelian yang dilakukan SUPERVISOR'
DEFINE BAR 9 OF indpop PROMPT '\<Takop Non Anggota' mess'Mengisi Takop Non Anggota'
...
DEFI WIND dokt;
FROM 2,(wcols()-86)/2 to 24,((wcols()-86)/2)+86 system title'Entry / Edit Item' colo rgb(0,0,0,129,126,101) font'foxprint',9 
...
DO WHILE.T.
   ...
   do while.t.
     ...
     @15.8,24 GET barcodew pict '@J 999999999999999' FONT'Book Antiqua',12 size 1,17
     ...
     case nu5=1
       ...
       if !found()
          ...
          endi   
       endi
       repl kbrg with kbrgw, nbrg with nbrgw, ukecil with ukecilw, hsat with hsatw, hjual with hjualw, barcode with barcodew
       exit
     case nu5=2
       acti wind konf
...
DEFI WIND dokt3;
FROM 0,(wcols()-130)/2 to wrows()-1,((wcols()-130)/2)+130 system title'Edit Multiple Stok' font'arial' clos
acti wind dokt2
tah=spac(7)
do while.t.
   clear
   ...
   IF ASMO='SUPERVISOR1'
      brow FIEL KBRG :H='KODE',;
           ...
           xcode:h='M_CODE',UKECIL :H='PIECE' :P='@Z 99,999',;
           HSAT :H='H. SATUAN' :P='@Z 99,999,999',;
           HJUAL :H='H. JUAL' :P='@Z 99,999,999';
           NOAPPE WIND DOKT3 for &kodi
   ELSE
      brow FIEL KBRG :H='KODE',;
           barcode, NBRG :H='NAMA BARANG',;
...
colo rgb(255,255,255,129,126,101) font'Times New Roman',12
DEFI WIND dokt3;
FROM 0,(wcols()-110)/2 to wrows()-1,((wcols()-110)/2)+110 system title'Mengganti artikel item - isi dg artikel baru' font'arial' clos
tglx=date()-180
ndo1=spac(28)
ndo2=spac(28)
acti wind dokt2
...
colo rgb(255,255,255,129,126,101) font'Times New Roman',12
DEFI WIND jen4;
FROM 0,(wcols()-90)/2 to wrows(),((wcols()-90)/2)+90 system title'Daftar Klasemen Barang' font'arial',8 clos
acti wind jen3
...
colo rgb(0,0,0,129,126,101) font'Book Antiqua',12 close
kangw=spac(5)
nangw=spac(20)
sele 1
set orde to 2
...
colo rgb(255,255,255,129,126,101) font'Times New Roman',12
DEFI WIND dokt3;
FROM 0,(wcols()-150)/2 to wrows()-1,((wcols()-150)/2)+150 system title'Daftar Supplier' font'arial' clos
acti wind dokt2
tah=spac(7)
do while.t.
   do case
...
use instansi inde inst1,inst2
DEFI WIND dokt;
FROM 3,(wcols()-80)/2 to 19,((wcols()-80)/2)+80 system title'Entry / Edit Instansi';
...
DO WHILE.T.
   ...
   @6.5,0 say'hdc0.bmp'bitm
   @12,0 say'crekam.bmp'bitm
   sele 1
   set orde to 1
   GO BOTTOM      
   IF BOF()         
      NO=RECNO()    
   ELSE             
      NO=VAL(RIGH(kins,3))+1
   ENDIF            
   kdokw=STUF('000',;          
               3-LEN(LTRIM(STR(NO)))+1 ,; 
               LEN(LTRIM(STR(NO))) ,;
               LTRIM(STR(NO)))
   kdokl=kdokw
   ??SYS(2002,1)
   ...
   do while.t.
     tejo=0
     @7,27 get kdokw pict'!!!' vali ckinsw() FONT'Book Antiqua',12 size 1,4
     @9.2,27 GET ndokw pict'@!' FONT'Book Antiqua',12 size 1,31
     @12.1,0 get nu5 PICTURE '@*IHT ;;' font 'Arial',9 size 2.3,18.8,0 default 0
     read
     IF READ()=12.or.nu5=3
        kal3=.t.
        EXIT
     ...
     case nu5=1
       ...
       if !found()
          ...
          endi   
       endi
       repl nins with ndokw, kins with kdokw
       exit
     case nu5=2
       acti wind konf
       @0,0 say 'confirm.bmp'bitm
...
DEFI WIND dokt;
FROM 3,(wcols()-80)/2 to 24,((wcols()-80)/2)+80 system title'Entry / Edit Anggota';
colo rgb(0,0,0,94,182,108) font'foxprint',9 
defi wind konf in wind dokt from 5,15.5 to 16.5,59 syst font'Arial',9 colo rgb(255,255,255,0,0,0) titl'Konfirmasi'
acti wind dokt
DO WHILE.T.
   ...
   do while.t.
     ...
     @9.2,27 GET ndokw pict'@!' FONT'Book Antiqua',12 size 1,31
     @13.5,27 GET mol vali cks() PICTURE '@^' from sera size 0.9,39 font 'Book Antiqua',12 defa 1
     @17.1,0 get nu5 PICTURE '@*IHT ;;' font 'Arial',9 size 2.3,18.8,0 default 0
     read
     IF READ()=12.or.nu5=3
        kal3=.t.
     ...
     case nu5=1
       ...
       if !found()
          ...
          endi   
       endi
       repl nang with ndokw, kang with kdokw, kins with kinsw, nins with ninsw
       exit
     case nu5=2
       acti wind konf
       @0,0 say 'confirm.bmp'bitm
...
if cextr(kdokw)
   ...
   if found().and.kgb<>spac(5)
      ...
      ndokw=nang
      ninsw=nins
      mol=ascan(sera,ninsw)
      sele 2
      seek trim(ninsw)
      if found()
         kinsw=kins
      endi
      @11.4,27 say kinsw pict'@!' FONT'Book Antiqua',14
      sele 1
      set orde to 1
   else   
      ndokw=spac(30)
...
clos data
DEFI WIND gla;
FROM 10.5,(wcols()-75)/2 to 24.7,((wcols()-75)/2)+75 system title'Daftar Instansi';
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND kot;
FROM 0,(wcols()-130)/2 to wrows()-1,((wcols()-130)/2)+130 system title'Daftar Instansi' font'arial' clos
SELE 1
use instansi inde inst1,inst2
SELE 2
use cust
...
do while.t.
   do case
   case mbar=1
      urtw='Urut No. Instansi'
      tam1='dari No.'
      tam2='s/d No.'
      gamb='99999'
      store spac(3) to tg1,tg2
   case mbar=2
      urtw='Urut Nama Instansi'
      tam1='dari Nama'
      tam2='s/d Nama'
      gamb='@!'
   ...
   @4.5,6 say tam1
   @5.7,6 say tam2
   @4.5,15 get tg1 pict gamb
   @5.7,15 get tg2 pict gamb
   ...
   case mbar=1
      ...
      ENDI
      NOREK=RECNO()
      kondi="kins>=trim(tg1).and.kins<=trim(tg2).and..not.eof()"
   case mbar=2
      SEEK trim(tg1)
      IF.NOT.FOUN()
         WAIT'DATA TIDAK ADA' WINDO
   ...
   do while &kondi
      ...
      sele 2
      appe blan
      repl kode with kodew, nama with materiw, k1 with tg1, k2 with tg2, urt with urtw
      sele 1
      set orde to mbar
      skip
   enddo
   ...
   do case
   case nu=1
        brow fiel kode:h='No. Instansi', nama:h='Instansi' wind kot noedit
   case nu=2
        repo form linx prev
        repo form linx to print prompt
   endcase     
enddo
deac wind gla
clos data
...
clos data
DEFI WIND gla;
FROM 10.5,(wcols()-75)/2 to 24.7,((wcols()-75)/2)+75 system title'Daftar Anggota';
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND kot;
FROM 0,(wcols()-130)/2 to wrows()-1,((wcols()-130)/2)+130 system title'Daftar Anggota' font'arial' clos
SELE 1
use cus inde cus1,cus2
SELE 2
use cust
...
do while.t.
   do case
   case mbar=1
      urtw='Urut No. Anggota'
      tam1='dari No.'
      tam2='s/d No.'
      gamb='99999'
      store spac(5) to tg1,tg2
   case mbar=2
      urtw='Urut Nama Anggota'
      tam1='dari Nama'
      tam2='s/d Nama'
      gamb='@!'
      store spac(30) to tg1,tg2
   ...
   do while &kondi
      ...
      sele 2
      appe blan
      repl kode with kodew, nama with materiw, alamat with jenisw,;
   ...
   do case
   case nu=1
        brow fiel kode, nama, alamat:h='Instansi', telp:h='No. Instansi' wind kot noedit
   case nu=2
        repo form lcus prev
...
do while.t.
  ...
  do while.t.
     ...
     do botal           
     IF ASMO<>'SUPERVISOR1'
     @0.5,9 get nbeliw pict'B999999' vali cabeli() colo rgb(0,0,0,166,205,167)FONT'Book Antiqua',14 size 1,9
...
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND jual5;
FROM 0,0 to wrows(),wcols() system title'Laporan pembelian' font'arial' clos
acti wind jual4
...
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND jual5;
FROM 0,(wcols()-120)/2 to wrows(),((wcols()-120)/2)+120 system title'Rekap pembelian' font'arial' clos
acti wind jual4
store spac(7) to kjua3,kjua4
if mbar=2
   store ctod('  /  /  ') to tawal,takhir
...
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND jual5;
FROM 0,(wcols()-136)/2 to wrows(),((wcols()-136)/2)+136 system title'Laporan pembelian' font'arial' clos
acti wind jual4
store ctod('  /  /  ') to tawal,takhir
do cartang
kjua3=tawal
...
do while.t.
  ...
  do while.t.
     ...
     @0.5,80 say nbeliw colo rgb(0,0,0,166,205,167)FONT'Book Antiqua',14 styl'b'
     @0.5,105 get tbeliw colo rgb(0,0,0,166,205,167)FONT'Book Antiqua',14 size 0.9,14
     @0.5,128.4 GET jtem spinner 1,0,10 font'Book Antiqua',12 size 0.9,3 defa 0
     ...
     if jur1=1
       ...
       @41,107 say susuke pict'@z 99,999,999' font'Book Antiqua',14 styl'b' colo rgb(255,255,255,40,54,40)
       if mlo
          sele 6
          bukw=righ(nbeliw,6)
          seek bukw
          if !found()
             if jtem=0
               if left(kangw,1)='0'
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '4101', perkiraan with 'Penjualan Barang Anggota',;
                       uraian with nangw, kredit with tot1, ttrans with tbeliw
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '1111', perkiraan with 'Kas',;
                       uraian with nangw, debet with tot1, ttrans with tbeliw
                  ...
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '4102', perkiraan with 'Penjualan Barang non Anggota',;
                       uraian with nangw, kredit with tot1, ttrans with tbeliw
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '1111', perkiraan with 'Kas',;
                       uraian with nangw, debet with tot1, ttrans with tbeliw
               ...
               if left(kangw,1)='0'
                  ...
                  repl bukti with bukw, kang with kangw, no_perk with '4101', perkiraan with 'Penjualan Barang Anggota',;
                       uraian with nangw, kredit with tot1, ttrans with tbeliw
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '1131', perkiraan with 'Piutang Barang Anggota',;
                       uraian with nangw, debet with tot1, ttrans with tbeliw
               else
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '4102', perkiraan with 'Penjualan Barang non Anggota',;
                       uraian with nangw, kredit with tot1, ttrans with tbeliw
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '1141', perkiraan with 'Piutang Barang non Anggota',;
                       uraian with nangw, debet with tot1, ttrans with tbeliw
               endi
             endi       
          endif
...
proc simp
     if simp
       ...
       next
       @41,107 say boyor-tot1 pict'@z 99,999,999' font'Book Antiqua',14 styl'b' colo rgb(255,255,255,40,54,40)
       if mlo
          acti wind jadi
          @0,0 say'prnt.bmp'bitm
          @0,25.4 say'prnt1.bmp'bitm
  ...
  gno='hd1.bmp'
     ...
     @0.5,23 get nangw pict'@!' FONT'Book Antiqua',14 size 0.9,38 disa
     @0.5,80 say nbeliw colo rgb(0,0,0,166,205,167)FONT'Book Antiqua',14 styl'b'
     @0.5,105 say tbeliw colo rgb(0,0,0,166,205,167)FONT'Book Antiqua',14 styl'b'
     READ
  SHOW GETS
     endif  
retu
...
use trans inde trans5
DEFI WIND jual;
FROM 0,(wcols()-168)/2 to 42,((wcols()-168)/2)+168 system title'NOTA SEKUNDER' font'foxprint',9;
colo rgb(0,0,0,40,54,40)
DEFI WIND jadi in wind jual FROM 12,15 to 20,70 system titl'Print' colo rgb(0,0,0,40,54,40) font'arial',9 
defi wind konf in wind jual from 10,28.5 to 21.5,72 syst font'Arial',9 colo rgb(255,255,255,0,0,0) titl'Info'
acti wind jual
       ...
       for mi=1 to 95
         ...
         if left(ki(mi),28)<>spac(28)
           ...
           REPL NJUAL WITH Nbeliw,TJUAL WITH Tbeliw,;
                Kbrg WITH Kbrgw,ukecil WITH Ukecilw, op with iif(jtem=0,'T','K'),;
                HJUAL WITH Hbeliw,TOTB WITH TOTBW,SPG WITH SPGW, kang with kangw,;
                DS WITH jasaw,KS WITH KSR,TD WITH tdw,period with wayah, ke with jtem, sek with 'S'
         endif       
       next
       susuke=0
       if boyor-tot1>-1.and.boyor-tot1<0
       ...
       if mlo
          ...
          if !found()
             if jtem=0
               if left(kangw,1)='0'
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '4107', perkiraan with 'Penjualan Sekunder Anggota',;
                       uraian with nangw, kredit with tot1, ttrans with tbeliw
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '1111', perkiraan with 'Kas',;
                       uraian with nangw, debet with tot1, ttrans with tbeliw
                  ...
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '4108', perkiraan with 'Penjualan Sekunder non Anggota',;
                       uraian with nangw, kredit with tot1, ttrans with tbeliw
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '1111', perkiraan with 'Kas',;
                       uraian with nangw, debet with tot1, ttrans with tbeliw
               ...
               if left(kangw,1)='0'
                  ...
                  repl bukti with bukw, kang with kangw, no_perk with '4107', perkiraan with 'Penjualan Sekunder Anggota',;
                       uraian with nangw, kredit with tot1, ttrans with tbeliw
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '1135', perkiraan with 'Piutang Sekunder Anggota',;
                       uraian with nangw, debet with tot1, ttrans with tbeliw
               else
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '4108', perkiraan with 'Penjualan Sekunder non Anggota',;
                       uraian with nangw, kredit with tot1, ttrans with tbeliw
                  appe blan
                  repl bukti with bukw, kang with kangw, no_perk with '1136', perkiraan with 'Piutang Sekunder non Anggota',;
                       uraian with nangw, debet with tot1, ttrans with tbeliw
               endi
             endi       
          endif
...
use trans inde trans5
DEFI WIND jual;
FROM 0,(wcols()-168)/2 to 42,((wcols()-168)/2)+168 system title'EDIT SEKUNDER' font'foxprint',9;
colo rgb(0,0,0,40,54,40)
DEFI WIND jadi in wind jual FROM 12,15 to 20,70 system titl'Print' colo rgb(0,0,0,40,54,40) font'arial',9 
defi wind konf in wind jual from 10,28.5 to 21.5,72 syst font'Arial',9 colo rgb(255,255,255,0,0,0) titl'Konfirmasi'
acti wind jual
       ...
       for mi=1 to 95
         ...
         if left(ki(mi),28)<>spac(28)
           ...
           REPL NJUAL WITH Nbeliw,TJUAL WITH Tbeliw,;
                ...
                DS WITH jasaw,KS WITH KSR,TD WITH tdw,period with wayah,;
                EDIT WITH ton, TEDIT WITH DATE(), oleh with asmo,;
                op with iif(jtem=0,'T','K'), kang with kangw, ke with jtem, sek with 'S'
         endif       
       next
       susuke=0
       if boyor-tot1>-1.and.boyor-tot1<0
...
if found()
   ...
   colo rgb(0,0,0,129,126,101) font'Book Antiqua',9 close
   mon=spac(5)
   totk=0
   sele 5
   go top
...
*end frox   
   ...
   appe blan
   repl nama with 'Tagihan semua INSTANSI bulan '+bulan, ab with 'f', total with totg, tgpri with tgpriw, wln with bulan, kode with kodew, instansi with instansiw, btm with 't'
   go top
   brow fiel no:r, nama:r, nota:r, tgl:r, nilai:p='@z 999,999,999':r, x:p='@z 999':r, ke:p='@z 999':r,;
             tagihan:p='@z 999,999,999':r, tunggakan:p='@z 999,999,999':r, denda:p='@z 999,999,999':r, total:p='@z 999,999,999':r wind dokt nomenu;
             title 'Instansi  :  '+kodew+'  '+instansiw
*   repo form tagix prev
   go top
...
*frox   
   ...
   brow fiel no:r, nama:r, nota:r, tgl:r, nilai:p='@z 999,999,999':r, x:p='@z 999':r, ke:p='@z 999':r,;
             ...
             title 'Instansi  :  '+kodew+'  '+instansiw+' TOTAL :'+tran(tots,'@z 999,999,999') 
 sele 8
 dele all 
 IF npw=2   
   sele 5
...
if found()
   ...
   colo rgb(0,0,0,129,126,101) font'Book Antiqua' close
   mon=spac(5)
   totk=0
   sele 5
   go top
...
use hut inde hut3
sele 4
use simpanan inde simpan3,simpan2
sele 5
use stagih
dele all
sele 6
...
if found()
   ...
   if found()
      do while kins=kodew.and.!eof()
         ...
         sele 5
         appe blan
         repl kode with kodew, instansi with instansiw, no with nom, nama with namaw, ab with 'h', tgpri with tgpriw, wln with bulan, in_out with 'M'
         notaw=spac(7)
         tglw=spac(10)
         pokokw=0
         wajibw=0
         ...
         sele 5
         repl pokok with pokokw, wajib with wajibw, manasuka with manasukaw, abc with abcw, tgl with dtoc(tgskr)
         sele 2
         skip
      enddo
   else
   ...
   defi wind dokt FROM 0,(wcols()-150)/2 to wrows(),((wcols()-150)/2)+150 system title 'Instansi  :  '+kodew+'  '+instansiw;
   colo rgb(0,0,0,129,126,101) font'Book Antiqua' close
   mon=spac(5)
   totk=0
   sele 5
   ...
   do while !eof()
      if mon=no
         mon=mon
         totk=pokok+wajib+manasuka+totk
         yor=recno()
         skip-1
         repl total with 0
         go yor
...
*end frox   
   ...
   go top
   ??sys(2002,1)
   brow fiel no:r, nama:r, tgl:r, pokok:p='@z 999,999,999':r, wajib:p='@z 999,999,999', manasuka:p='@z 999,999,999',;
             total:p='@z 999,999,999':r wind dokt nomenu;
             title 'Instansi  :  '+kodew+'  '+instansiw
   repl all total with wajib+manasuka          
   mon=spac(5)
   totk=0
   sele 5
   go top
...
*frox   
   ...
   appe blan
   repl nama with 'Tagihan semua INSTANSI bulan '+bulan, ab with 'f', total with totg, tgpri with tgpriw, wln with bulan, kode with kodew, instansi with instansiw, btm with 't'
   repo form stagix prev
   go top
   repo form stagix to print prompt          
else
   clos data
   return
endi
...
use hut inde hut3
sele 4
use simpanan inde simpan3,simpan2,simpan4,simpan5,simpan6
sele 5
use stagih
dele all
sele 6
...
@2.7,0 get npw PICTURE '@*IHT ;;' font 'Arial',9 size 3,19.5,0 default 0
READ
if read()=12.or.npw=3 &&.or.last()=27
   exit
endif   
sele 5
dele all
...
if found()
   ...
   if found()
      do while &kond
         ...
         sele 5
         repl pokok with pokokw, wajib with wajibw, manasuka with manasukaw, tgl with dtoc(tgskr)
         sele 2
         set orde to 1 
         skip
      enddo
...
*end frox   
   ...
   sele 5
   go top
   brow fiel no:r, nama:r, tgl:r, in_out:h='M/K':p='!':v=in_out $ 'MK', pokok:p='@z 999,999,999', wajib:p='@z 999,999,999',;
             manasuka:p='@z 999,999,999', total:p='@z 999,999,999':r wind dokt nomenu;
             title 'Instansi  :  '+kodew+'  '+instansiw+' TOTAL :'+tran(tots,'@z 999,999,999')
 IF npw=2
   sele 5 
   go top
   do while !eof()
      ...
      nm=no
      namaw=nama
      store spac(6) to pobukw,wabukw,mabukw
      sele 4
      set orde to 4
      go bott
      ne=100001
      if bof()
         ...
         go bott
         if pokok>0.and.wajib>0.and.manasuka>0
            ne=val(righ(mabuk,6))+1
         endif   
         if pokok>0.and.wajib>0.and.manasuka=0
            ne=val(righ(wabuk,6))+1
wait wabuk+' '+str(ne) wind
         endif   
         if pokok>0.and.wajib=0.and.manasuka=0
            ne=val(righ(pobuk,6))+1
         endif   
*
         if wajib>0.and.pokok=0.and.manasuka=0
            ne=val(righ(wabuk,6))+1
         endif   
*
         if manasuka>0.and.wajib>0.and.pokok=0
            ne=val(righ(mabuk,6))+1
         endif   
         if manasuka>0.and.wajib=0.and.pokok=0
            ne=val(righ(mabuk,6))+1
      ...
      if pokokw>0.and.wajibw>0.and.manasukaw>0
         nomor=str(ne)
         pjnomor=len(ltrim(nomor))
         pobukw=left('000000',len('000000')-pjnomor)+ltrim(nomor)
         ne=ne+1
         nomor=str(ne)
         pjnomor=len(ltrim(nomor))
         wabukw=left('000000',len('000000')-pjnomor)+ltrim(nomor)
         ne=ne+1
         nomor=str(ne)
         pjnomor=len(ltrim(nomor))
         mabukw=left('000000',len('000000')-pjnomor)+ltrim(nomor)
      endif
      if pokokw>0.and.wajibw>0.and.manasukaw=0
         nomor=str(ne)
         pjnomor=len(ltrim(nomor))
      ...
      seek kinsw+kangw+left(dtoc(tgskr,1),6)
      If !found()
         appe blan
         repl kang with kangw, kins with kinsw, pokok with pokokw, wajib with wajibw, manasuka with manasukaw,;
              in_out with in_outw, tg with tgw, pobuk with pobukw, wabuk with wabukw, mabuk with mabukw
         if pokokw>0
            sele 7
            appe blan
            repl bukti with pobukw, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '3001',;
                 perkiraan with 'Simpanan Pokok', debet with iif(in_outw='K',pokokw,0), kredit with iif(in_outw='M',pokokw,0)
            appe blan
            repl bukti with pobukw, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '1111',;
                 perkiraan with 'Kas', debet with iif(in_outw='M',pokokw,0), kredit with iif(in_outw='K',pokokw,0)
         endif
         if wajibw>0
            sele 7
            appe blan
            repl bukti with wabukw, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '3003',;
                 perkiraan with 'Simpanan Wajib', debet with iif(in_outw='K',wajibw,0), kredit with iif(in_outw='M',wajibw,0)
            appe blan
            repl bukti with wabukw, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '1111',;
                 perkiraan with 'Kas', debet with iif(in_outw='M',wajibw,0), kredit with iif(in_outw='K',wajibw,0)
         endif
         if manasukaw>0
            sele 7
            appe blan
            repl bukti with mabukw, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '2212',;
                 perkiraan with 'Simpanan Manasuka', debet with iif(in_outw='K',manasukaw,0), kredit with iif(in_outw='M',manasukaw,0)
            appe blan
            repl bukti with mabukw, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '1111',;
                 perkiraan with 'Kas', debet with iif(in_outw='M',manasukaw,0), kredit with iif(in_outw='K',manasukaw,0)
         endif
      Endif
      sele 5
      skip
   ...
   sele 4
   go top
   dele all for pokok=0.and.wajib=0.and.manasuka=0.and.!eof()
 ENDI  
else
   clos data
   return
...
if found()
   ...
   if found()
      do while kins=kodew.and.!eof()
         ...
         if found()
            ...
            set orde to 1
            go grk
            do while kins+kang+left(dtoc(tg,1),6)=kodew+nom+left(dtoc(tgskr,1),6).and.!eof()
               kangw=kang
               kinsw=kins
               pokokw=pokok
               wajibw=wajib
               ...
               tgw=tg
               sele 5
               repl abc with abcw, in_out with in_outw,;
                    tgl with dtoc(tgw), pokok with pokokw, wajib with wajibw, manasuka with manasukaw
               hedr=hedr+1
               sele 4
               set orde to 1
               skip
   ...
   defi wind dokt FROM 0,(wcols()-170)/2 to wrows()-1,((wcols()-170)/2)+170 system colo rgb(0,0,0,129,126,101) font'Book Antiqua' close
   mon=spac(5)
   totk=0
   sele 5
   go top
...
*frox   
   ...
   do while !eof()
      ...
      nm=no
      namaw=nama
      stor spac(6) to pobukw, wabukw, mabukw, pobukx, wabukx, mabukx
      sele 4
      set orde to 1
      go bott
      if bof()
...
*
      ...
      if pokokw>0.and.wajibw>0.and.manasukaw>0
            nomor=str(ne)
            pjnomor=len(ltrim(nomor))
            pobukx=left('000000',len('000000')-pjnomor)+ltrim(nomor)
            ne=ne+1
            nomor=str(ne)
            pjnomor=len(ltrim(nomor))
            wabukx=left('000000',len('000000')-pjnomor)+ltrim(nomor)
            ne=ne+1
            nomor=str(ne)
            pjnomor=len(ltrim(nomor))
            mabukx=left('000000',len('000000')-pjnomor)+ltrim(nomor)
      endif
      if pokokw>0.and.wajibw>0.and.manasukaw=0
            nomor=str(ne)
            pjnomor=len(ltrim(nomor))
      ...
      if pokokw=0.and.wajibw=0.and.manasukaw=0
         store spac(6) to pobukx,wabukx,mabukx
      endif
      if pokokw>0.and.wajibw=0.and.manasukaw>0
            nomor=str(ne)
            pjnomor=len(ltrim(nomor))
...
*
      ...
      if found()
         ...
         wabukw=wabuk
         mabukw=mabuk     
         repl pokok with pokokw, wajib with wajibw, manasuka with manasukaw, in_out with in_outw
         if pokokw>0.and.pobukw=spac(6)
            repl pobuk with pobukx
         endif
         if wajibw>0.and.wabukw=spac(6)
            repl wabuk with wabukx
         endif
         if manasukaw>0.and.mabukw=spac(6)
            repl mabuk with mabukx
         endif
         sele 7
         seek pobukw+'3001'
         if found()
            repl debet with iif(in_outw='M',0,pokokw), kredit with iif(in_outw='M',pokokw,0)
         else   
            if pokokw>0
               sele 7
               appe blan
               repl bukti with pobukx, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '3001',;
                    perkiraan with 'Simpanan Pokok', debet with iif(in_outw='K',pokokw,0), kredit with iif(in_outw='M',pokokw,0)
            endif
         endif     
         seek pobukw+'1111'
         if found()
            repl debet with iif(in_outw='M',pokokw,0), kredit with iif(in_outw='M',0,pokokw)
         else   
            if pokokw>0
               sele 7 
               appe blan
               repl bukti with pobukx, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '1111',;
                    perkiraan with 'Kas', debet with iif(in_outw='M',pokokw,0), kredit with iif(in_outw='K',pokokw,0)
            endif        
      endif     
*
         seek wabukw+'3003'
         if found()
            repl debet with iif(in_outw='M',0,wajibw), kredit with iif(in_outw='M',wajibw,0)
         else   
            if wajibw>0
               sele 7
               appe blan
               repl bukti with wabukx, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '3003',;
                    perkiraan with 'Simpanan Wajib', debet with iif(in_outw='K',wajibw,0), kredit with iif(in_outw='M',wajibw,0)
            endif
         endif     
         seek wabukw+'1111'
         if found()
            repl debet with iif(in_outw='M',wajibw,0), kredit with iif(in_outw='M',0,wajibw)
         else   
            if wajibw>0
               sele 7
               appe blan
               repl bukti with wabukx, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '1111',;
                    perkiraan with 'Kas', debet with iif(in_outw='M',wajibw,0), kredit with iif(in_outw='K',wajibw,0)
            endif        
         endif     
*
         seek mabukw+'2212'
         if found()
            repl debet with iif(in_outw='M',0,manasukaw), kredit with iif(in_outw='M',manasukaw,0)
         else   
            if manasukaw>0
               sele 7
               appe blan
               repl bukti with mabukx, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '2212',;
                    perkiraan with 'Simpanan Manasuka', debet with iif(in_outw='K',manasukaw,0), kredit with iif(in_outw='M',manasukaw,0)
            endif
         endif     
         seek mabukw+'1111'
         if found()
            repl debet with iif(in_outw='M',manasukaw,0), kredit with iif(in_outw='M',0,manasukaw)
         else   
            if manasukaw>0
               sele 7
               appe blan
               repl bukti with mabukx, kang with kangw, ttrans with tgw, uraian with namaw, no_perk with '1111',;
                    perkiraan with 'Kas', debet with iif(in_outw='M',manasukaw,0), kredit with iif(in_outw='K',manasukaw,0)
            endif        
         endif     
      endif
...
USE cus INDE cus1
SELE 3
USE simpanan INDE simpan3
sele 4
use ljual1
sele 5
use ljual2
DEFI WIND jual4;
FROM 10.5,(wcols()-75)/2 to 24.7,((wcols()-75)/2)+75 system title'Daftar Simpanan';
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND jual5;
FROM 0,0 to wrows(),wcols() system title'Laporan simpanan' font'arial' clos
acti wind jual4
store ctod('  /  /  ') to tawal,takhir
do cartang
kjua3=tawal
...
do while.t.
   ...
   sele 5
   dele all
   store 0 to tot,to1,to2,to3
   NRK=0
   sele 3
   go top
   do while !eof()
     if tg>=kjua3.and.tg<=kjua4
      ksw=kins
      kdokw=kang
      tanggalw=dtoc(tg)
      jmlw=pokok
      ...
      sele 5
      appe blan
      repl ks with ksw, pasien with pasienw, kdok with kdokw,  dokter with dokterw,;
           tanggal with tanggalw, exp1 with exp1w, jml with jmlw, exp2 with exp2w, harga with hargaw,;
           kode with kodew, jasa with jasaw, total with totalw, spg with spgw,;
           tg1 with dtoc(kjua3), tg2 with dtoc(kjua4)
     endif      
     sele 3
     skip
   ...
   sele 5
   appe blan
   repl jml with to1, harga with to2, jasa with to3, total with tot, tanggal with spac(4)+'TOTAL'
   sele 5
   go top   
   do case
   case nujl1=1
        brow fiel ks:h='No.', pasien:h='Instansi', kdok:h='No.Induk', dokter:h='Anggota', tanggal,;
             exp1:h='KM/KK', jml:h='Pokok':p='@Z 999,999,999',;
             exp2:h='KM/KK', harga:h='Wajib':p='@Z 999,999,999',;
             kode:h='KM/KK', jasa:h='Manasuka':p='@z 999,999,999',;
             total:p='@Z 9,999,999,999', spg:h='M/K' wind jual5 noedit nomenu ;
             title dtoc(kjua3)+' - '+dtoc(kjua4)
   case nujl1=2
        repo form simx prev
        repo form simx to print prompt
   endcase     
enddo
deac wind jual4
do emn
...
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND jual5;
FROM 0,0 to wrows(),wcols() system title'Laporan penjualan' font'arial' clos
acti wind jual4
store spac(7) to kjua3,kjua4
if mbar=2
   store ctod('  /  /  ') to tawal,takhir
...
*   sele 4
   ...
   case nujl1=1
        brow fiel tanggal, no , kode, obat:h='Item',;
              ...
              total:p='@Z 9,999,999,999', dokter:h='Anggota':r wind jual5 noedit nomenu ;
...
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND jual5;
FROM 0,(wcols()-136)/2 to wrows(),((wcols()-136)/2)+136 system title'Laporan penjualan' font'arial' clos
acti wind jual4
store ctod('  /  /  ') to tawal,takhir
do cartang
kjua3=tawal
...
*
   ...
   sele 5
   appe blan
   repl total with tot, jml with tot1
   sele 5
   go top   
   do case
   case nujl1=1
        brow fiel tanggal, no, jml:p='@Z 99,999.99', harga:p='@Z 99,999,999.9',;
              total:p='@Z 9,999,999,999.9', dokter:h='Anggota' wind jual5 noedit nomenu ;
...
use ljual2
DEFI WIND jual4;
FROM 10.5,(wcols()-78)/2 to 24.7,((wcols()-78)/2)+78 system title'Daftar penjualan / Anggota';
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND jual5;
FROM 0,(wcols()-136)/2 to wrows(),((wcols()-136)/2)+136 system title'Laporan penjualan' font'arial' clos
acti wind jual4
...
*
   ...
   case nujl1=1
        brow fiel tanggal, no:h='Nota', kode, obat:h='Item', jml:p='@Z 99,999.99', harga:p='@Z 99,999,999.9',;
              total:p='@Z 9,999,999,999.9', jas3:h='X':p='@z 99'  wind jual5 noedit nomenu ;
              title dtoc(kjua3)+' - '+dtoc(kjua4)+spac(3)+'-'+spac(3)+kbr+spac(2)+'-'+spac(2)+trim(nbg)
   case nujl1=2
...
do while.t.
   ...
   do case
   case nujl1=1
        brow fiel kdok:h='No.', dokter:h='Anggota', tanggal, no:h='Nota' , kode, obat:h='Item',;
              jml:p='@Z 99,999.99', harga:p='@Z 99,999,999.9',;
              total:p='@Z 9,999,999,999.9', jas3:h='X' wind jual5 noedit nomenu ;
              title urtw+' '+iif(mbar=2,dtoc(kjua3),trim(kjua3))+' s/d '+iif(mbar=2,dtoc(kjua4),trim(kjua4))
   case nujl1=2
...
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND jual5;
FROM 0,(wcols()-64)/2 to wrows(),((wcols()-64)/2)+64 system title'Rekap penjualan' font'arial' clos
acti wind jual4
store ctod('  /  /  ') to tawal,takhir
do cartang
kjua3=tawal
...
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND jk1;
FROM 0,(wcols()-134)/2 to wrows(),((wcols()-134)/2)+134 system title'Daftar penjualan kasir' font'arial' clos
acti wind jk
store ctod('  /  /  ') to tawal,takhir
do cartang
kjua3=tawal
...
kgb=spac(9)
   if cextr(kbn1)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg1=kbrg
         nbg1=nbrg
         trf1=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto1=trf1*jmp1
      else
         kbn1=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn2)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg2=kbrg
         nbg2=nbrg
         trf2=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto2=trf2*jmp2
      else
         kbn2=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn3)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg3=kbrg
         nbg3=nbrg
         trf3=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto3=trf3*jmp3
      else
         kbn3=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn4)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg4=kbrg
         nbg4=nbrg
         trf4=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto4=trf4*jmp4
      else
         kbn4=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn5)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg5=kbrg
         nbg5=nbrg
         trf5=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto5=trf5*jmp5
      else
         kbn5=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn6)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg6=kbrg
         nbg6=nbrg
         trf6=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto6=trf6*jmp6
      else
         kbn6=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn7)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg7=kbrg
         nbg7=nbrg
         trf7=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto7=trf7*jmp7
      else
         kbn7=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn8)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg8=kbrg
         nbg8=nbrg
         trf8=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto8=trf8*jmp8
      else
         kbn8=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn9)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg9=kbrg
         nbg9=nbrg
         trf9=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto9=trf9*jmp9
      else
         kbn9=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn10)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg10=kbrg
         nbg10=nbrg
         trf10=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto10=trf10*jmp10
      else
         kbn10=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn11)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg11=kbrg
         nbg11=nbrg
         trf11=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto11=trf11*jmp11
      else
         kbn11=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn12)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg12=kbrg
         nbg12=nbrg
         trf12=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto12=trf12*jmp12
      else
         kbn12=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn13)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg13=kbrg
         nbg13=nbrg
         trf13=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto13=trf13*jmp13
      else
         kbn13=spac(13)
      endif
...
kgb=spac(9)
   if cextr(kbn14)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg14=kbrg
         nbg14=nbrg
         trf14=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto14=trf14*jmp14
      else
         kbn14=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn15)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg15=kbrg
         nbg15=nbrg
         trf15=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto15=trf15*jmp15
      else
         kbn15=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn16)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg16=kbrg
         nbg16=nbrg
         trf16=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto16=trf16*jmp16
      else
         kbn16=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn17)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg17=kbrg
         nbg17=nbrg
         trf17=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto17=trf17*jmp17
      else
         kbn17=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn18)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg18=kbrg
         nbg18=nbrg
         trf18=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto18=trf18*jmp18
      else
         kbn18=spac(13)   
      endif
...
kgb=spac(9)
   if cextr(kbn19)
      ...
      if found().and.kgb<>spac(9)
         ...
         kbg19=kbrg
         nbg19=nbrg
         trf19=iif(jtem<=1,hjual,hsat*(1+(jtem*0.02)))
         sto19=trf19*jmp19
      else
         kbn19=spac(13)   
      endif
...
proc prjual
  ...
  ?
  ?'Anggota : '+kangw+' / '+trim(nangw) font 'foxprint',8
  ?'Instansi: '+instans font 'foxprint',8
  ?
...
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND dokt3;
FROM 0,0 to wrows(),wcols() system title'Melihat yang edit penjualan' font'arial' clos
acti wind dokt2
store ctod('  /  /  ') to tawal,takhir
do cartang
jancok1=tawal
...
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND dokt3;
FROM 0,0 to wrows(),wcols() system title'Melihat yang edit pembelian' font'arial' clos
acti wind dokt2
store ctod('  /  /  ') to tawal,takhir
do cartang
jancok1=tawal
...
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND dokt3;
FROM 0,(wcols()-106)/2 to wrows()-1,((wcols()-106)/2)+106 system title'Melihat yang edit pembelian' font'arial' clos
acti wind dokt2
store ctod('  /  /  ') to tawal,takhir
do cartang
tglx=tawal
...
colo rgb(0,0,0,166,205,167) font'Times New Roman',12
DEFI WIND dokt3;
FROM 0,(wcols()-106)/2 to wrows()-1,((wcols()-106)/2)+106 system title'Pemakaian program' font'arial' clos
acti wind dokt2
store ctod('  /  /  ') to tawal,takhir
do cartang
tg1=tawal
...
*
proc dtop
modi wind screen title'KP-RI "Bahagia" unit waserda' colo rgb(0,0,0,182,238,184) icon file '48.ico' nominim nogrow nozoom noclos;
font'arial'
clea
@2,(wcols()-150)/2 say'dsk00.bmp'bitm
@2,((wcols()-150)/2)+8.4 say'dsk01.bmp'bitm
@2,((wcols()-150)/2)+16.7 say'dsk02.bmp'bitm
@2,((wcols()-150)/2)+25 say'dsk03.bmp'bitm
@2,((wcols()-150)/2)+33.4 say'dsk04.bmp'bitm
@2,((wcols()-150)/2)+41.7 say'dsk05.bmp'bitm
@2,((wcols()-150)/2)+50 say'dsk06.bmp'bitm
@2,((wcols()-150)/2)+58.4 say'dsk07.bmp'bitm
@2,((wcols()-150)/2)+66.7 say'dsk08.bmp'bitm
@2,((wcols()-150)/2)+75 say'dsk09.bmp'bitm
@2,((wcols()-150)/2)+83.4 say'dsk10.bmp'bitm
@2,((wcols()-150)/2)+91.7 say'dsk11.bmp'bitm
@2,((wcols()-150)/2)+100 say'dsk12.bmp'bitm
@2,((wcols()-150)/2)+108.4 say'dsk13.bmp'bitm
@2,((wcols()-150)/2)+116.7 say'dsk14.bmp'bitm
@2,((wcols()-150)/2)+125.0 say'dsk15.bmp'bitm
@2,((wcols()-150)/2)+133.3 say'dsk16.bmp'bitm
@2,((wcols()-150)/2)+141.6 say'dsk17.bmp'bitm
retu
*
PROCEDURE DFTBOR
para naaw
...
set readb on
DEFI WIND pas2 FROM 1,10 to 37.8,128 system title'Daftar Item' clos colo rgb(0,0,0,200,227,201) font'Times New Roman'icon file'48.ico'
KGB=SPAC(9)
sele 1
set orde to 2  
seek trim(naaw)
...
set readb on
DEFI WIND pas2 FROM 0,(wcols()-118)/2 to wrows()-1,((wcols()-118)/2)+118 system title'Daftar Item' clos colo rgb(0,0,0,200,227,201) font'Times New Roman'icon file'48.ico'
KGB=SPAC(9)
sele 1
set orde to 2  
seek trim(naaw)
...
do while left(nbrg,len(trim(naaw)))=trim(naaw).and.!eof()
   ct=ct+1
   AM(ct)=nbrg+spac(1)+tran(ukecil,'@Jz 999,999.99')+spac(1)+tran(hjual,'@z 99,999,999')+spac(1)+kbrg
   skip
enddo
acti wind pas2
clea
...
set readb on
DEFI WIND pas2 FROM 1,10 to 37.8,128 system title'Daftar Suplier' clos colo rgb(0,0,0,200,227,201) font'Book Antiqua'icon file'48.ico'
KGB=SPAC(5)
sele 1
set orde to 2  
seek trim(naaw)
...
set readb on
DEFI WIND pas2 FROM 1,30 to 37.8,100 system title'Daftar Rekening' clos colo rgb(0,0,0,200,227,201) font'Book Antiqua'icon file'48.ico'
KGB=SPAC(7)
sele 1
set orde to 2  
seek trim(naaw)
...
set readb on
DEFI WIND pas2 FROM 1,30 to 37.8,100 system title'Daftar Instansi' clos colo rgb(0,0,0,200,227,201) font'Book Antiqua'icon file'48.ico'
KGB=SPAC(3)
sele 1
set orde to 2  
seek trim(naaw)
...
set readb on
DEFI WIND pas2 FROM 1,10 to 37.8,128 system title'Daftar Anggota' clos colo rgb(0,0,0,200,227,201) font'Book Antiqua'icon file'48.ico'
KGB=SPAC(5)
sele 3
set orde to 2  
seek trim(naaw)
...
DEFINE PAD kpapad OF _MSYSMENU PROMPT '\Jual   ' COLOR SCHEME 3 ;
	KEY ALT+J, '' mess'Menu Kontrol Transaksi Penjualan'
DEFINE PAD simpad OF _MSYSMENU PROMPT '\Simpanan   ' COLOR SCHEME 3 ;
	KEY ALT+G, '' mess'Menu Kontrol Simpanan';
	skip for upper(left(ASMO,5))='KASIR'
DEFINE PAD akupad OF _MSYSMENU PROMPT '\Akuntansi   ' COLOR SCHEME 3 ;
	KEY ALT+G, '' mess'Menu Kontrol Akuntansi';
	skip for upper(left(ASMO,5))='KASIR'
DEFINE PAD indpad   OF _MSYSMENU PROMPT '\Tools   '   COLOR SCHEME 3 ;
	KEY ALT+R, '' mess'Reindex data'
